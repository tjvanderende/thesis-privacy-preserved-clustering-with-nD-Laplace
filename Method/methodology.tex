...
The most important one here is the preserving of \gls{gi} according to formula \ref{algo:2d-geo-indistinguishability}.
...
Therefore, we also calculate the error between the non-private and perturbed data \ref{theory:evaluation-dp}.
