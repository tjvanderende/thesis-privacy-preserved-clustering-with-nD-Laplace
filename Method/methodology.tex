...
\begin{table}[h]
  \begin{tabular}{|l|p{6cm}|l|l|}
    ...
    \hline
    Preference     & We decided to use the median similarity as described in section \ref{theory:clustering-ap} & p=Median    & \makecell{Seeds dataset \\ Heart dataset \\ Circle dataset \\ Line dataset \\ Skewed dataset} \\
    \hline
    Damping factor & Default value as specified in section \ref{theory:clustering-ap}                           & damping=0.5 & \makecell{Seeds dataset \\ Heart dataset \\ Circle dataset \\ Line dataset \\ Skewed dataset}       \\
    \hline
  \end{tabular}
