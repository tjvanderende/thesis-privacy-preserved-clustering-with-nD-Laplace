...
The value of \(\theta\) decreases after the $\approx 7$ dimensions have been reached. Subsequently, the hyper-surface area reaches a maximum, so the value of $\theta$ decreases towards 0 \footnote[\ref{footnote:hypersphere}].
...
\centering
  ...
  \caption{Illustration of the decreasing volume while increasing the number of dimensions \footnote[\ref{footnote:hypersphere}].}
