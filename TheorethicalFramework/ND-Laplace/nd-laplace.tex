...
%This issue is because a grid of $n*m$ dimensions has a $O(n*m)$ complexity. 

So, to extend Andres et al.'s approach to n-dimensional data, we need an efficient way to search points in an n-dimensional hypersphere.
