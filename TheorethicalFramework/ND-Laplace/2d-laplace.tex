...
If noise is added, it cannot be ensured that this data falls outside this range (figure \ref{figure:truncation-2d}).
\begin{figure}[ht]
...
This would require an interactive setup of the mechanism instead of a non-interactive one. \newline
