...
This jeopardizes \replaced{\gls{gi}}{geo-indistinguishability,} and therefore Min et al. provided a modified version of Theorem \ref{theorem:discretization} to support 3-dimensional data \citep{9646489}.
