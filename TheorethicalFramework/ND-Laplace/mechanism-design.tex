...
\begin{figure}[H]
  \includesvg[width=1.1\textwidth]{TheorethicalFramework/ND-Laplace/Images/final_mechanism_design}
  \caption{Non-interactive mechanism design for kD-Laplace.}
  \label{fig:final-mechanism-design}
\end{figure}
\todo[inline]{Improve image}
%\todo[inline]{Modify to density-kD-Laplace \& kD-Laplace for image reporting}
