...
\begin{figure}[h]
  ...
  \label{fig:local-dp}
\end{figure}
\todo[inline]{Explain interactive versus non-interactive}
...
\todo[inline]{More introduction about geo-indistinguishability}
\todo[inline]{Describe notion of geo-indistinguishability}
