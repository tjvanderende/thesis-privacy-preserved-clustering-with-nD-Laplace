...
%A separate investigation by Javaraman et al. examined the efficacy of differential privacy through Membership Inference attacks proposed by Shokri et al. and Yeom et al. 
%Furthermore, they also leveraged Yeom et al.'s attribute inference attack.
Within this thesis, our focus is mainly on Membership Inference attacks.
...
To reach this goal, it is sufficient to concentrate on membership inference attacks. %using available code implementations \citep{nicolae_adversarial_2019}.
\newpage
