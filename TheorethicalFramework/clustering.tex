...
\replaced{In the previous sections, three types of cluster algorithms have been introduced, each related to distance. For each type, the most popular algorithms have been explained, and to have a representative selection, one algorithm from each type is chosen for use in the research.}
