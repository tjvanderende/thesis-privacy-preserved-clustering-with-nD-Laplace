...
Since we employ various types of datasets and algorithms, it is desirable to have an automated method for determining this value.
For this reason, research has also been conducted on an extension of DBSCAN called OPTICS.

This algorithm attempts different epsilon values to achieve the best result \todo{Add OPTICS source} \citep{ankerst_optics_nodate}.
