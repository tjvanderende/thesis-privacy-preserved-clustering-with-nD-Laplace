...
This sub-section describes the various types of cluster algorithms.
Subsequently, we will investigate the cluster algorithms and select a few suitable for this study.

\todo[inline]{Explain why these three algorithms}
\subsection{Parameter selection}
\todo[inline]{Gets refactoring based on previous section}
...
\textbf{Choosing K:} The most crucial parameter of the K-Means algorithm is the value of $k$.
...
\todo[inline]{Replace with own image}
\begin{figure}[H]
