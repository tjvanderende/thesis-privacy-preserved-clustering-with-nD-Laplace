...
\end{enumerate}
\todo[inline]{Database icon: this is the symbol of a database rather than a single record}
...
\todo[inline]{Footnotes do not work in the table, redirect to the first page}
%\subsection{Summary}
