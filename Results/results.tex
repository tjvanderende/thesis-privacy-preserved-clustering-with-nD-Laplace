...
Please refer to the plots in the appendix for the same scores for the variants of kD-Laplace. \todo{add the other results to the appendix}.
\newpage
...
\end{figure}
\todo[inline]{Add if results are available}
...
\end{figure}
kD-Laplace scores high for \gls{ag} for \gls{ami}, with a peak of 0.83 for epsilon 9.
...
The privacy distance comparison plots are included in the appendix: \todo{add appendix reference}.
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.30\textwidth}
